...
construction_year = st.number_input(
    "Construction Year", value=2000, min_value=1900, max_value=2024
)
...
primary_energy_consumption_sqm = st.number_input(
    "Primary Energy Consumption in kWh/sqm", value=250.0
)
...
equipped_kitchen = st.selectbox(
    "Equipped Kitchen", ("NOT_INSTALLED", "SEMI_EQUIPPED", "INSTALLED")
)
